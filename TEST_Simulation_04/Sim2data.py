...
from TEST_Simulation_04.json2png_EDA import Json2Png
...
class WindowClass(QMainWindow, form_class) :
    def __init__(self) :
       ...
       # movie.start()
        ...
        # 성능 지표 버튼(TEST_Simulation_03)
        self.pushButton_2.clicked.connect(self.urlGo)
    ...
    # TEST_Simulatioin_03에서 사용하는 것( 지금은 사용안한다.)
    ...
    # 성능지표 UI에서 버튼 클릭시
    def urlGo(self) :
        self.webEngineView_Test.load(QUrl("http://localhost:28333/"))
